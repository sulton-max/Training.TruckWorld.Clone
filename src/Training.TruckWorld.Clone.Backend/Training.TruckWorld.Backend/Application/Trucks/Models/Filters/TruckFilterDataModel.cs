...
public class TruckFilterDataModel
{
    ...
    public TruckFilterDataModel(IEnumerable<KeyValuePair<string, ListingType>>? listingTypes, IEnumerable<KeyValuePair<string, TruckCategory>>? categories, IEnumerable<KeyValuePair<string, string>>? manufacturers, IEnumerable<KeyValuePair<string, string>>? state, IEnumerable<KeyValuePair<string, TruckCondition>>? conditions, IEnumerable<KeyValuePair<string, string>>? country)
    {
...
public class EntityNotFoundException : Exception
{
    ...
    public EntityNotFoundException(Type type, Guid id) : base($"Entity of type {type} with ID {id} not found!")
    {
        Type = type;
        Id = id;
    }
